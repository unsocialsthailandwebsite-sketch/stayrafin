  ...
  return (
    ...
    >
      <div className="relative overflow-hidden aspect-[4/3] mb-6 shadow-lg rounded-2xl group-hover:shadow-2xl transition-all duration-500 ease-out">
        ...
        {/* Price badge, bottom-right of the image */}
        {property.price && (
          <div className="absolute bottom-4 right-4 z-20 bg-white/95 backdrop-blur-md text-stayra-charcoal font-sans text-xs font-bold px-3 py-1.5 rounded-full shadow-md">
            {property.price}
          </div>
        )}
      </div>
