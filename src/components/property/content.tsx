...
/**
* Optional content rendered between the About section and the Amenities
* section — e.g. a property's "The Spaces" room-by-room breakdown.
*/
betweenAboutAndAmenities?: React.ReactNode;
}
...
{/* Optional slot — e.g. "The Spaces" — shown between About and Amenities */}
{betweenAboutAndAmenities}
