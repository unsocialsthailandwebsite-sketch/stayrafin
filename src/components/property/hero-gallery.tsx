  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.55fr_1fr] gap-2.5 md:h-[540px]">
        {/* Hero image.
            Mobile height was 52vh — on a typical phone that's over half the
            screen spent on one photo, before the title, rating, or facts
            chips even start. Shrunk to 32vh so a phone opening this page
            sees the photo AND the key facts below it without scrolling,
            matching the compact reference layout that prompted this. */}
        <div className="relative group rounded-xl overflow-hidden bg-gray-100 h-[32vh] md:h-full">
