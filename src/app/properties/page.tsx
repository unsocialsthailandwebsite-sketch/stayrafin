...
export const metadata = {
  ...
  description:
    "Explore Stayra's handpicked Jaipur villas: Choti Haveli, a haveli-style home on Ajmer Road, and Kankas House, a 4BHK private pool villa on Delhi Road.",
    ...
    <main className="pt-24 pb-16">
      ...
      <div className="container mx-auto px-4 mb-12 text-center">
        ...
        <div className="text-gray-500 max-w-3xl mx-auto font-sans mt-6 space-y-4 text-left md:text-center">
          <p>
            Stayra is a small, curated collection of private villas and haveli-style homes in and
          ...
          <p>
            ...
            a one-bedroom haveli-style home on Ajmer Road built for two. Whether you are planning
