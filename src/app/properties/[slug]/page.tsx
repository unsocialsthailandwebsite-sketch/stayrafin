...
const PROPERTY_SPACES: Record<string, PropertySpace[]> = {
  "kankas-house": [
    ...
    },
    {
      ...
      "detail": "First-floor king room with a freestanding bathtub in the ensuite, the Aravallis beyond the window."
    },
    {
      "name": "Bedroom Four",
      "imageIndex": 10,
    ...
    },
    {
      ...
      "imageIndex": 5,
      "meta": "Ground floor · Dining",
      "detail": "Seats eight, with the kitchen a few steps away. Breakfast here, or whatever hour the chef and the guests agree on."
    },
    {
      "name": "The Lounge",
      "imageIndex": 11,
  ...
  "kankas-house": [
    {
      ...
      "detail": "A chef lives at the house and cooks from 8am to 10pm, preparing meals for the whole house, up to 12 guests. Rajasthani, North Indian, or something plainer for the children. No buffet hours — you decide when to eat. Earlier breakfasts and later dinners are no trouble with a little notice."
    },
    {
      "name": "Caretaker",
